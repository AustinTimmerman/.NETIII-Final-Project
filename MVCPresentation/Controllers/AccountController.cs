    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    if (usrMgr.AuthenticateUser(model.Email, model.Password))
                    {
                        User oldUser = usrMgr.GetUserByEmail(model.Email);
        ...
        public async Task<ActionResult> RegisterUser(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    if (usrMgr.GetUserByEmail(model.Email) != null)
                    {
                    ...
                    else
                    {
                        ...
                        if(usrMgr.InsertNewUser(model.Email, model.Email, usrMgr.HashSha256(model.Password), user.Roles) == 1)
                        {
